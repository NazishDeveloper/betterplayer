...
//                   onTap: () {
//                     CustomBetterPlayer.customBetterPlayerState.playerBack();
//                   },
//                 ),) : SizedBox.shrink(),
//               // Spacer(),
//               Padding(
  ...
  Widget _buildMainWidget() {
    ...
    return GestureDetector(
      onTap: () {
        ...
        if(!CustomBetterPlayer.isLocked) {
          controlsNotVisible
              ? cancelAndRestartTimer()
              : changePlayerControlsNotVisible(true);
        }
      ...
      onDoubleTap: () {
        ...
        cancelAndRestartTimer();
        CustomBetterPlayer.isLocked = false;
        changePlayerControlsNotVisible(false);
      },
      onLongPress: () {
        if (BetterPlayerMultipleGestureDetector.of(context) != null) {
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.only(left: 15),
                child: GestureDetector(
                  child: Icon(Icons.arrow_back),
                  onTap: () {
                    CustomBetterPlayer.isInitilizedForback? CustomBetterPlayer.customBetterPlayerState.playerBack(): Navigator.of(context).pop();
                  },
                ),),
              Spacer(flex: 5,),
              !betterPlayerController!.isTrailer ?
          ...
          children: <Widget>[
            ...
            !_betterPlayerController!.isTrailer? Expanded(
              ...
              child: Row(
                ...
                children: [
                  PlayerSubtitles(),
                  PlayerRestart(controller: betterPlayerController),
                  GestureDetector(
                    onTap: (){
                      changePlayerControlsNotVisible(true);
                      CustomBetterPlayer.isLocked = true;
                      Fluttertoast.showToast(msg: "Double Tap To Unlock",);
                    },
                    child: PlayerLock(),
                  ),
                  PlayerListOf(),
